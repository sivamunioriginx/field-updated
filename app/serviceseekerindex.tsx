...
const createStyles = (screenHeight: number, screenWidth: number) => {
  ...
  const styles = StyleSheet.create({
    ...
    statusInfoContainer: {
      ...
      borderRadius: getResponsiveValue(14, 10, 18),
      borderWidth: 1,
      borderColor: '#60a5fa',
    ...
    ratingContainer: {
      ...
      borderRadius: getResponsiveValue(16, 14, 18),
      borderWidth: 1,
      borderColor: '#c7d2fe',
      shadowColor: '#6366f1',
    ...
    ratingDescriptionInput: {
      borderWidth: 1,
      borderColor: '#c7d2fe',
      borderRadius: getResponsiveValue(14, 12, 16),
      padding: getResponsiveSpacing(10),
      fontSize: getResponsiveFontSize(14),
      minHeight: getResponsiveValue(80, 70, 90),
      textAlignVertical: 'top',
      backgroundColor: '#ffffff',
      color: '#111827',
    },
