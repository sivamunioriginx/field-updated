...
export default function Payments({ searchQuery: externalSearchQuery, onSearchChange }: PaymentsProps) {
  ...
  const fetchPayments = async () => {
    try {
      ...
      console.log('📡 Fetching payments from:', API_ENDPOINTS.ADMIN_PAYMENTS);
      const response = await fetch(API_ENDPOINTS.ADMIN_PAYMENTS);
      ...
      if (data.success) {
        ...
        console.log('✅ Payments fetched:', paymentsData.length, 'records');
  ...
  if (payments.length === 0) {
    return (
      <View style={styles.emptyContainer}>
        ...
        <Text style={styles.emptyText}>There are no payments available at the moment.</Text>
      </View>
    );
  }
          ...
          >
            <View style={styles.tableContainer}>
              ...
              <View style={styles.tableHeader}>
                ...
                <View style={[styles.tableCell, styles.tableHeaderCell, { width: isDesktop ? 160 : isTablet ? 140 : 120 }]}>
                  <Ionicons name="bookmark" size={isDesktop ? 16 : 14} color="#ffffff" />
                  <Text style={styles.tableHeaderText}>Booking ID</Text>
                </View>
                <View style={[styles.tableCell, styles.tableHeaderCell, { width: isDesktop ? 250 : isTablet ? 220 : 200 }]}>
                  <Ionicons name="card" size={isDesktop ? 16 : 14} color="#ffffff" />
              ...
              {paginatedPayments.map((payment, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <View style={[styles.tableCell, { width: isDesktop ? 160 : isTablet ? 140 : 120 }]}>
                      <Text style={styles.tableCellText}>#{payment.booking_id}</Text>
                    </View>
                    <View style={[styles.tableCell, { width: isDesktop ? 250 : isTablet ? 220 : 200 }]}>
                      <Text style={styles.tableCellText}>#{payment.payment_id}</Text>
                    </View>
          ...
          <Text style={styles.paginationInfo}>
            {recordsPerPage === 'ALL' 
              ...
              : (() => {
                  ...
                  return `Showing ${start} to ${end} of ${filteredPayments.length} entries`;
                })()
            }
          </Text>
