...
const createStyles = (screenHeight: number, screenWidth: number) => {
  ...
  return StyleSheet.create({
    ...
    filterButtonActive: {
      paddingHorizontal: getResponsiveSpacing(20, screenWidth),
      paddingVertical: getResponsiveSpacing(10, screenWidth),
      borderRadius: getResponsiveSpacing(20, screenWidth),
      backgroundColor: '#000',
      borderWidth: 1,
      borderColor: '#000',
    },
    ...
    newBadge: {
      ...
      borderRadius: getResponsiveSpacing(4, screenWidth),
      marginLeft: getResponsiveSpacing(4, screenWidth),
    },
    newBadgeText: {
      color: '#FFF',
      fontSize: getResponsiveFontSize(10, screenWidth),
      fontWeight: '700',
    },
    servicesGrid: {
      paddingHorizontal: 6,
    ...
    saleBadge: {
      position: 'absolute',
      top: getResponsiveSpacing(8, screenWidth),
      left: getResponsiveSpacing(8, screenWidth),
      backgroundColor: '#22C55E',
      paddingHorizontal: getResponsiveSpacing(8, screenWidth),
      paddingVertical: getResponsiveSpacing(4, screenWidth),
      borderRadius: getResponsiveSpacing(4, screenWidth),
    },
    saleBadgeText: {
      color: '#FFF',
    ...
    bannerButton: {
      backgroundColor: '#000',
      paddingHorizontal: getResponsiveSpacing(24, screenWidth),
    ...
    bannerImage: {
      width: getResponsiveWidth(140, screenWidth),
      height: '100%',
    ...
    instantBadge: {
      ...
      paddingHorizontal: getResponsiveSpacing(6, screenWidth),
      paddingVertical: getResponsiveSpacing(2, screenWidth),
      borderRadius: getResponsiveSpacing(4, screenWidth),
      alignSelf: 'flex-start',
    ...
    topOffersContainer: {
      marginTop: getResponsiveSpacing(8, screenWidth),
      marginBottom: getResponsiveSpacing(20, screenWidth),
    },
    topOfferCard: {
      width: getResponsiveWidth(160, screenWidth, 140, 180),
      backgroundColor: '#FFFFFF',
    ...
    discountBadge: {
      position: 'absolute',
      top: getResponsiveSpacing(8, screenWidth),
      right: getResponsiveSpacing(8, screenWidth),
      backgroundColor: '#FF3B30',
      paddingHorizontal: getResponsiveSpacing(8, screenWidth),
      paddingVertical: getResponsiveSpacing(4, screenWidth),
